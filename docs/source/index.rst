...
pg-discuss is a comment management system backend written in Python on top of a
...
or Nikola. pg-discuss can also be used with a CMS such as WordPress, or within
your own dynamic web app that needs a robust comment system.
...
but have slightly different design goals.
