...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "6s27nhrp9xeqpqjpqc94ga9fjt83w08j6wz1q4syzx8jhfshqaj0",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "pg-discuss"),
    ...
    actions = [
      ...
      ( title = (defaultText = "New Comment System"),
        command = .myCommand
    ...
    metadata = (
      ...
      website = "https://pg-discuss.sprin.io",
      # This should be the app's main website url.

      codeUrl = "https://github.com/sprin/pg-discuss",
      ...
      shortDescription = (defaultText = "embeddable comment widget"),
