...
Revision ID: 43bf2bac071
Revises: None
Create Date: 2015-09-15 02:10:04.326120

"""

# revision identifiers, used by Alembic.
revision = '43bf2bac071'
down_revision = None
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['identity_id'], ['identity.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('identity_id', 'comment_id', 'rel_type', name='_comment_identity_uc')
    )
