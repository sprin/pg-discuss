...
define('app/i18n',["app/config", "app/i18n/de", "app/i18n/en", "app/i18n/fr", "app/i18n/ru", "app/i18n/it", "app/i18n/eo", "app/i18n/sv", "app/i18n/nl", "app/i18n/el_GR", "app/i18n/es", "app/i18n/zh_CN"], function(config, de, en, fr, ru, it, eo, sv, nl, el, es, zh) {
...
buf.push("</div>");
var show_footer = !conf.locked || conf.vote
if ( show_footer)
{
buf.push("<div class=\"isso-comment-footer\">");
if ( conf.vote)
{
...
buf.push("<div" + (jade.attr("id", 'isso-loader-' + (comment.name) + '', true, false)) + " class=\"isso-comment-loader\"><a href=\"#\" class=\"load_hidden\">↓ load more comments (" + (jade.escape((jade_interp = pluralize('comment-hidden', comment.hidden_replies)) == null ? '' : jade_interp)) + ")</a></div>");}.call(this,"comment" in locals_for_with?locals_for_with.comment:typeof comment!=="undefined"?comment:undefined,"pluralize" in locals_for_with?locals_for_with.pluralize:typeof pluralize!=="undefined"?pluralize:undefined));;return buf.join("");
};  return fn;});


define('jade!app/text/continue-thread', function () {  var fn = function template(locals) {
var buf = [];
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (comment, pluralize) {
buf.push("<div" + (jade.attr("id", 'isso-continue-thread-' + (comment.name) + '', true, false)) + " class=\"isso-continue-thread\"><a href=\"#\" class=\"continue-thread\">↪ continue this thread (" + (jade.escape((jade_interp = pluralize('comment-hidden', comment.deeper_replies)) == null ? '' : jade_interp)) + ")</a></div>");}.call(this,"comment" in locals_for_with?locals_for_with.comment:typeof comment!=="undefined"?comment:undefined,"pluralize" in locals_for_with?locals_for_with.pluralize:typeof pluralize!=="undefined"?pluralize:undefined));;return buf.join("");
};  return fn;});

define('app/jade',["libjs-jade-runtime", "app/utils", "jade!app/text/postbox", "jade!app/text/comment", "jade!app/text/comment-loader", "jade!app/text/continue-thread"], function(runtime, utils, tt_postbox, tt_comment, tt_comment_loader, tt_continue_thread) {
    "use strict";
